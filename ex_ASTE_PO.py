...
def ex_ASTE():
    ...
    lims_v_p1       = [0, 2*np.pi]
    gridsize_p1     = [301, 301] # The gridsizes along the u and v axes
    ...
    s.inputBeam.transBeam(offTrans=foc_pri)
    ...
    s.PO.plotField(s.system["cam1"].grid_x, s.system["cam1"].grid_y)
