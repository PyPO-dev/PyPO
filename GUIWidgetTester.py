...
Plane = [
    ...
    InputDescription(inType.checkbox, "checkBox", staticValue="pla", toolTip="flips normal vectors of element to be crated", prefill=True),
    InputDescription(inType.vectorStrings, "string", hints=["a", "&&&"], prefill=True, numFields= 2),
    InputDescription(inType.vectorIntegers, "integers", hints=[5267000000458877599756], prefill=True),
