...
def propRaysInp(frameDict, elemDict):
    ...
    propRays = [
            ...
            InputDescription(inType.vectorStrings, "frame_out", label="Name of output frame", numFields=1),
            InputDescription(inType.vectorFloats, "epsilon", label="Accuracy", hints=[1e-3], numFields=1),
            InputDescription(inType.vectorIntegers, "nThreads", label="# of threads", hints=[1], numFields=1),
            InputDescription(inType.vectorFloats, "t0", label="Initial guess", hints=[100], numFields=1),
